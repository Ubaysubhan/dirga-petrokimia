...
@section('container')
<form class="min-w-full divide-y divide-gray-200">
  <div class=" min-w-full m-6 divide-y divide-gray-200">
    <div>
      <div>
        <h3 class="mt-4 text-lg leading-6 font-medium text-gray-900">Profile</h3>
