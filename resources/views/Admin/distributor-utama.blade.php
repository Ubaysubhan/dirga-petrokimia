...
<h1 class="m-5">Data Distributor Utama</h1>

<a href="/export-utama" class="btn btn-success m-4" target="_blank" download>EXPORT EXCEL</a>
@csrf
...
<div class=" justify-content-center table-responsive m-4 " style="width:170vh">
    <table class="table table-bordered table-xl">
      <thead class="table-warning rounded">
        <tr>
          ...
          <th scope="col" class="text-center">Surat Pengajuan Calon Distributor Utama </th>
      ...
      <tbody class="text-center">
        ...
        @if ($value->status_verifikasi == null)    
            <form action="/Admin/distributor-utama/{{ $value->id }}" method="POST">
                @csrf
                @method('put')
       ...
       <form action="/getDownloadBiodata_utama" method="get"  >
  ...
  <script>
     var loadFile = function(event) {
      ...
      download_output.download = "Surat Akta";
        ...
        {{ $value->akta->image }}
        <span> </span>
       <form action="/getDownloadAkta_utama" method="get"  >
  ...
  <form action="/getDownloadNpwp_utama" method="get"  >
      ...
      @endif
       ...
       <form action="/getDownloadSuratIzinUsaha_utama" method="get"  >
      ...
      <form action="/getDownloadSuratIzinUsaha_utama" method="get"  >
       ...
       <form action="/getDownloadGudang_utama" method="get"  >
                ...
                <ul class="list-group list-group-flush">
                    @foreach ($value->armada as $data)
                        <li class="list-group-item">{{ $data->stnk }}
                            ...
                            <form action="/getDownloadArmada_utama" method="get"  >
   ...
   <form action="/Admin/distributor-utama/{{$value->id}}" method="POST" class="d-inline"  >
